...
1. Introduction
   ...
   WRF-DA (Weather Research and Forecasting Data Assimilation) outputs are typically stored in NetCDF format, containing 3D or 4D model variables. Post-processing is critical for:
